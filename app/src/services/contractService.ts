...
export const CONTRACT_ADDRESSES = {
  MODRED_IP: CONTRACT_ADDRESS_JSON["ModredIPDeployModule#ModredIP"] as `0x${string}`,
  ERC6551_REGISTRY: CONTRACT_ADDRESS_JSON["ModredIPDeployModule#MockERC6551Registry"] as `0x${string}`,
  ERC6551_ACCOUNT: CONTRACT_ADDRESS_JSON["ModredIPDeployModule#MockERC6551Account"] as `0x${string}`,
};
